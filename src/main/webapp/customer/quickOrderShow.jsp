			...
			<div class="span2">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a
							href="quickOrderShow.action">快捷下单</a></li>
			...
			<div class="span9 main-content">
				...
				<form action="quickOrderCommit.action"  method="post" class="form-horizontal"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="senderProvince" id="province" class="input-small"
								placeholder="省" /> <input name="senderCity" type="text" id="city"
								class="input-small" placeholder="市" /> <input name="senderTown" type="text"
								id="town" class="input-small" placeholder="县" /> <input
								type="text" id="address" name="senderAddress" required="true"
								class="street" placeholder="详细地址"><font
								style="font-weight: bold; font-size: 16px;" color="red">*</font>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="receiverNumber" type="text"
								required="true" class="span4 m-wrap"> <font
								style="font-weight: bold; font-size: 16px;" color="red">*</font>
							<span for="tel" class="help-inline"></span>
						</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="province" class="input-small"
								placeholder="省" name="receiverProvince" /> <input type="text" id="city"
								class="input-small" placeholder="市" name="receiverCity"/> <input type="text"
								id="town" class="input-small" placeholder="县" name="receiverTown"/> <input
								type="text" id="address"   required="true"
								class="street" placeholder="详细地址" name="receiverAddress"><font
								style="font-weight: bold; font-size: 16px;" color="red">*</font>
							<span for="address" class="help-inline"></span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="weight" type="text"
								class="span4 m-wrap" number="true"> (公斤)<span
					...
					<div class="control-group">
						<div class="controls">
							<button type="submit"  class="btn btn-primary">
								<i class="icon-ok icon-white"></i>下 单
							</button>
						</div>
					</div>
